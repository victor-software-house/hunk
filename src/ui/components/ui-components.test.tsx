...
describe("UI components", () => {
  ...
  test("the bundled navigator keeps the applied History range highlighted", async () => {
          ...
          loadHistory: async () => ({
            ...
            history: {
              refs: [
                ...
                { name: "middle", kind: "branch", commitId: "b".repeat(40) },
                { name: "feature", kind: "branch", commitId: "c".repeat(40) },
              ],
              commits: [],
            },
          }),
    ...
    try {
      ...
      expect(frame).toContain("B * main");
      expect(frame).toContain("│ b middle");
      expect(frame).toContain("H b feature");
      ...
      await act(async () => setup.mockInput.pressEnter());
      frame = await render();
      expect(ranges).toEqual(["main...feature", "feature...middle"]);
